...
public class Gesture : BaseFinger{
	...
	{
		Vector3 dir = pickedObject.transform.position - pickedCamera.transform.position;
		Vector3 normardir = Vector3.Project(dir,pickedCamera.transform.forward);
		return this.GetTouchToWorldPoint(normardir.magnitude);
	}
